        ...
        <div class="flex justify-between items-center">
            ...
            <div class="flex items-center space-x-4">
                <form method="GET" class="flex items-center space-x-4">
                    <div>
                        <select name="year" class="rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
                ...
                <a href="{{ route('staff.accounts.ledger', ['account' => $account->id, 'year' => $year, 'month' => $month, 'export' => true]) }}" 
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <div class="mb-4">
                        <h3 class="text-lg font-medium text-gray-900">Saldo Awal: Rp {{ number_format($saldoAwal, 0, ',', '.') }}</h3>
                    </div>
